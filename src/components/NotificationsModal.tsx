...
type NotificationType = 'order_created' | 'order_updated' | 'order_status' | 'inventory_alert' | 'system' | 
              ...
              >
                <div className="flex items-start gap-2 sm:gap-3">
                  <div className={`p-1.5 sm:p-2 rounded-lg ${
                    notification.type === 'order_edited' || notification.type === 'batch_completed'
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      ...
                      <span className="text-[10px] sm:text-xs text-gray-400 font-['Inter'] ml-2">
